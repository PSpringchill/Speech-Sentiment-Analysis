...
#### 1. Data Collection
We collected and analyzed 362 speech segments from 39+ speakers:
- **Duration**: Total 45+ minutes of speech
- **Languages**: Primarily Thai with some English segments
- **Recording Conditions**: Various environments and noise levels
- **Speaker Diversity**: Age range 18-65, balanced gender distribution
